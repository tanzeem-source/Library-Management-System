...
//                   <tr key={user._id} className={(index+1)%2 === 0 ? "bg-gray-50" : ""}></tr>
//                 ))
//               }
...
const Users = () => {
  ...
  // Filter users with the role "User" once at the top
              ...
              <tbody>
                {filteredUsers.map((user, index) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-2 text-left">{user.name || "N/A"}</td>
                    <td className="px-4 py-2 text-left">{user.email || "N/A"}</td>
