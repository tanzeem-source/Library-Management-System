    ...
    <>
      <main className="relative flex-1 p-6 pt-28">
        ...
        <div className="flex flex-col-reverse xl:flex-row">
          {/* LEFT SIDE */}
          <div className="flex flex-[4] flex-col gap-7 lg:gap-7 lg:py-5 xl:min-h-[85.5vh]">
            <div className="flex flex-[4] flex-col gap-7">
            ...
            <div className="bg-white p-7 text-lg sm:text-xl xl:text-3xl 2xl:text-4xl min-h-52 font-semibold relative flex-[3] flex justify-center items-center rounded-2xl">
              <h4 className="overflow-y-hidden text-center text-gray-800">
